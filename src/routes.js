...
const RideFare = React.lazy(() => import('./views/rideFare/RideFare'))
...
const routes = [
  ...
  { path: '/admin/Admin', name: 'Admin', element: Admin, exact: true },
  { path: '/company/Company', name: 'Company', element: Company, exact: true },
  { path: '/drivers/Driver', name: 'Driver', element: Driver, exact: true },
